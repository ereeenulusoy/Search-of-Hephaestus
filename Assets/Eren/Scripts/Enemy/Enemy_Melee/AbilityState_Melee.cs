...
public class AbilityState_Melee : EnemyState
{
    ...
    {
        base.Exit();
        enemy.moveSpeed = moveSpeed; // the speed is gonna change during animation, so we need to set it to default value.
    ...
    public override void AbilityTrigger()
    {
        ...
        newAxe.GetComponent<Enemy_Axe>().AxeSetup(enemy.axeFlySpeed, enemy.player, enemy.axeTimer);
    }
}
